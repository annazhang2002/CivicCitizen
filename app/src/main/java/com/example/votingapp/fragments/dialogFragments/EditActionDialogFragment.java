...
public class EditActionDialogFragment extends DialogFragment {
    ...
    private static final String TAG = "EditActionDialogFrag";
    ...
    public EditActionDialogFragment() {
        // Required empty public constructor
    }

    public static EditActionDialogFragment newInstance(PackageManager packageManager1, Action action) {
        EditActionDialogFragment frag = new EditActionDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_edit_action_dialog, container, false);
    }
